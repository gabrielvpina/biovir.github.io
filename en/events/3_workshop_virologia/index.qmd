---
title: "III Virology Workshop"
pagetitle: "III Virology Workshop — BioVirLab"
description-meta: "Third Virology Workshop at UESC, organised by the Virus Bioinformatics (BioVirLab) and Applied Pathology and Genetics (LAPAGEN) laboratories, with support from the Brazilian Society of Virology (SBV)."
---

<!-- gerado por scripts/build-eventos.py - nao editar a mao;
     edite eventos/3_workshop_virologia/ e rode ./build.sh -->

<p class="event-back"><a class="no-external" href="../../events.html">← All events</a></p>

::: {.event-meta}
25–26 Mar 2026 · Ilhéus, Brazil
:::

![](../../../eventos/3_workshop_virologia/capa.png){.event-cover fig-alt="III Virology Workshop"}

::: {.lead}
Third Virology Workshop at UESC, organised by the Virus Bioinformatics (BioVirLab) and Applied Pathology and Genetics (LAPAGEN) laboratories, with support from the Brazilian Society of Virology (SBV).
:::
...
![Programme of the III Virology Workshop at UESC](../../../eventos/3_workshop_virologia/fotos/palestras.png)
...
![Organising team of the III Virology Workshop at UESC](../../../eventos/3_workshop_virologia/fotos/equipe.jpeg)
